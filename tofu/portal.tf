...
# provision.sh = migrate + services + publish-static (DEBUG-gated) + bootstrap + hooks. Not part of
# the service, so a failed provision is a visible CI failure, not a task-start rollback.
